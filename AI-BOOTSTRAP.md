...
- Mọi AI giao tiếp hoặc nhận việc trực tiếp từ Đặng Minh Hiếu phải đọc `docs/context/AI-WORKING-PREFERENCES.md` trước khi gom yêu cầu, viết prompt hoặc thực thi.
