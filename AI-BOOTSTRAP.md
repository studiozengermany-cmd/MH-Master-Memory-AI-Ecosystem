...
Claude Code là công cụ dùng ít hơn, ưu tiên cho audit, phản biện độc lập, phân tích lỗi khó hoặc nhiệm vụ chuyên biệt. Mở tại thư mục gốc repository; `CLAUDE.md` tự nhập `AGENTS.md`.

## Google Antigravity

Antigravity là **môi trường thi công chính**. Thêm repository thành Project/Workspace và chạy agent trong thư mục gốc. `GEMINI.md` dẫn agent về `AGENTS.md`, vai trò và tài liệu lõi.
