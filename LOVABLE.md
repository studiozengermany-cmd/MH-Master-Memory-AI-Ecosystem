...
- Khi bàn giao, trạng thái là `ĐÃ THI CÔNG` kèm Preview/diff; chỉ ghi `CHỜ QUYẾT ĐỊNH` khi thiếu một lựa chọn thật và chỉ gọi hoàn thành khi có bằng chứng kiểm chứng.
